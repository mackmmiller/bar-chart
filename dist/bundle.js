...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_css__ = __webpack_require__(463);
...
function chart(data) {
	...
	parseTime = __WEBPACK_IMPORTED_MODULE_0_d3__["j" /* timeParse */]("%Y-%m-%d");
	...
	const yScale = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleLinear */]()
						.domain([0,__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](dataset,(d)=>d[1])]).nice()
						.range([h-padding,padding]);
	const xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* scaleTime */]()
						.domain([__WEBPACK_IMPORTED_MODULE_0_d3__["e" /* min */](dataset,(d)=>d[0]),__WEBPACK_IMPORTED_MODULE_0_d3__["d" /* max */](dataset,(d)=>d[0])]).nice()
						.range([padding, w-padding]);

	let div = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */]("body").append("div")
		.attr("class","tooltip")
		.style("opacity", 0);
	...
	svg.selectAll("rect")
		...
		.on("mouseover", (d)=>{
			let parseDate = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* timeFormat */]("%B-%Y");
